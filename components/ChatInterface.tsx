          ...
          <div className="flex items-center gap-3 pb-1">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                Barnett Bain's Public KnowledgeBot
              </h1>
              {isInitialized && (
          ...
          {!isInitialized ? (
            ...
            <div className="text-center py-16">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-3">
                Welcome to Barnett Bain's Public KnowledgeBot
              </h2>
              <p className="text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
                This assistant is based on Barnett Bain's public content.
                Responses are for informational purposes only and may not be
                100% accurate. All intellectual property belongs to Barnett Bain.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto mb-8">
                ...
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Filmmaker, author, and creativity coach bridging mindfulness, emotional intelligence, and transformative storytelling media.
                  </p>
                </div>
                ...
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Get specific video guidance from Barnett's content library
                  </p>
                </div>
              </div>
            </div>
